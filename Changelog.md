...
**8.10.13_2**
- Fix outgoing mail by adjusting `smtp_settings` to always use the SMTP config.

**8.10.13_1**
- Entrypoint fixes
- Downgrade gitlab-shell to 3.2.1 (matching omnibus) to resolve permissions issues on merges.
- Downgrade gitlab-workhorse to 0.7.8 (matching omnibus).
**8.10.13**
- gitlab: upgrade to EE v8.10.13, security fixes!!!
- Bump minimum required version to 8.10.7, the last version released.

**8.10.7_1**
- Last version tested with entrypoint script fixes.

**8.10.4**
- gitlab: upgrade to EE v8.10.4.
- nginx: Startup and template fixes for GitLab container registry support.
- sidekiq: Support for pages and elasticsearch queue support.
- docker-compose: Preliminary support for a dev instance of all these services.  ES to come.
- gitlab-shell: Upgrade to 3.3.3.
- gitlab-workhorse: Upgrade to 0.7.9.
